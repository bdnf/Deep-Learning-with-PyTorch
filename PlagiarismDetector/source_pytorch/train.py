...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=1, metavar='I',
                        help='number of input features (default: 1)')
    parser.add_argument('--hidden_dim', type=int, default=1, metavar='H',
                        help='number of hidden layer of NN (default: 1)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='O',
                        help='number of output features (default: 1)')
